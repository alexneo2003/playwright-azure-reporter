...
test.describe('Publish results - testResult', () => {
  test('correct orgUrl config, correct token, incorrect testCaseId', async ({ runInlineTest, server }) => {
    ...
    expect(result.output).toContain(
      'No test points found for test case [33] associated with test plan 4. Check, maybe testPlanId, what you specified, is incorrect.'
    );
  ...
  test('incorrect planId', async ({ runInlineTest, server }) => {
    ...
    expect(result.output).toContain('azure: [3] foobar - failed');
    expect(result.output).toContain(
      'No test points found for test case [3] associated with test plan 44. Check, maybe testPlanId, what you specified, is incorrect'
    );
